...
import com.uit.calculator.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("package com.uit.calculator", Context.MODE_PRIVATE);
    ...
    protected void onPause() {
        ...
        boolean equalsControlToSave = buttonEqualsControl;
        ...
        editor.putBoolean("equal", equalsControlToSave);
    ...
    public void checkDivisor(String expressionForCalculate) {
        if (expressionForCalculate.contains("/")) {
            ...
            if (newResult.equals("0.0")){
                mainBinding.textViewHistory.setText("Divisor cannot be zero!");
            }else{
